...
public class GeneratePDFFileIText {
    ...
    private static final String iTextExampleImage = "C:/practica_profesional/evaluaciones_new/images/FF_logo.jpg";
    /**
    ...
    public static void main(String args[]) {
        ...
        generatePDFFileIText.createPDF(new File("test.pdf"));
    }
}